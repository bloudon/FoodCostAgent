...
export default function WebsiteIndustryGroups() {
  const { lang } = useLanguage();
  const t = newPageTranslations[lang];
  const p = t.industryGroups;
  const contactHref = lang === "es" ? "/es/contact" : "/contact";
  usePageEvent("industry_page_viewed", { segment: "restaurant-group", language: lang });
  ...
  return (
    <MarketingLayout>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link href={contactHref}>
            <Button
              ...
              data-testid="btn-groups-hero-cta"
            >
      ...
      {/* Challenge */}
      <section className="py-20 bg-white" data-testid="groups-challenge">
      ...
      {/* How it works */}
      <section className="py-20 bg-gray-50" data-testid="groups-how-it-works">
