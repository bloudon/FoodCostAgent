...
- **Deferred cleanup — Approved 2026-08-07:** Historical/#981 duplicate paths are intentionally left in place; deletion or quarantine is a separate approved follow-up after regression evidence. See `docs/mobile-architecture-reconciliation.md`.
