...
- Two-Stage Signup Flow: Lead capture (/signup) → Account activation (/activate) → Onboarding (/onboarding, single-page store name/code form). Email auto-fills on activation page. No duplicate data entry between stages.
