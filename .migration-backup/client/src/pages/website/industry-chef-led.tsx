...
export default function WebsiteIndustryChefLed() {
  ...
  return (
    <MarketingLayout>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link href={contactHref}>
            <Button
              ...
              data-testid="btn-chef-led-hero-cta"
            >
      ...
      {/* Challenge */}
      <section className="py-20 bg-white" data-testid="chef-led-challenge">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            <div className="flex-1">
              ...
              <p className="text-gray-500 leading-relaxed mb-6">{p.challenge.body}</p>
      ...
      {/* How it works */}
      <section className="py-20 bg-gray-50" data-testid="chef-led-how-it-works">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-500 leading-relaxed mb-7">{p.howItWorks.body}</p>
            <ul className="space-y-3">
