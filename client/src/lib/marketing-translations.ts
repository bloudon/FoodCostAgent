  ...
  en: {
    ...
    pricing: {
      meta: {
        ...
        description:
          "Simple, transparent pricing for restaurant inventory management and BOH software. Starter at $149/mo for one location, Pro from $228/mo for multi-location, Enterprise custom. 14-day opportunity review included.",
      },
      badge: "Simple, Transparent Pricing",
      headline: "A Plan for Every Operation",
      subheadline:
        "All paid plans include photo-based setup, live recipe costing, vendor order guides, and a 14-day opportunity review. Cancel anytime.",
      ...
      startFreeTrial: "Start 14-Day Opportunity Review",
      contactSales: "Contact Sales",
      noCardRequired: "Cancel anytime",
      fourteenDayTrial: "14-day opportunity review included",
      ...
      footerNote:
        "All paid plans include a 14-day opportunity review. Cancel anytime. Enterprise plans are billed via invoice.",
      ...
      faqItems: [
        {
          ...
          a: "There's no permanent free plan — but every paid plan comes with a 14-day opportunity review with full access. Cancel anytime.",
        },
        {
        ...
        {
          q: "What's included in the 14-day opportunity review?",
          a: "Full access to all features in the plan you choose for 14 days. Photo scanning, recipe costing, vendor order guides, everything. You won't be charged until the 14 days end, and you can cancel any time before then.",
        },
        {
  ...
  es: {
    ...
    pricing: {
      meta: {
        ...
        description:
          "Precios transparentes para software de gestión de inventario para restaurantes. Starter $149/mes, Pro desde $228/mes para múltiples sucursales, Enterprise personalizado. Revisión de oportunidad de 14 días incluida.",
      },
      badge: "Precios simples y transparentes",
      headline: "Un plan para cada operación",
      subheadline:
        "Todos los planes de pago incluyen configuración por foto, costeo de recetas en vivo, guías de proveedores y revisión de oportunidad de 14 días. Cancela cuando quieras.",
      ...
      startFreeTrial: "Iniciar Revisión de 14 Días",
      contactSales: "Contactar ventas",
      noCardRequired: "Cancela cuando quieras",
      fourteenDayTrial: "Revisión de 14 días incluida",
      ...
      footerNote:
        "Todos los planes de pago incluyen una revisión de oportunidad de 14 días. Cancela cuando quieras. Los planes Enterprise se facturan mediante factura.",
      ...
      faqItems: [
        {
          ...
          a: "No hay un plan gratuito permanente, pero cada plan de pago incluye una revisión de oportunidad de 14 días con acceso completo. Cancela cuando quieras.",
        },
        {
        ...
        {
          q: "¿Qué incluye la revisión de 14 días?",
          a: "Acceso completo a todas las funciones del plan que elijas durante 14 días. No se te cobrará hasta que terminen los 14 días, y puedes cancelar en cualquier momento antes.",
        },
        {
