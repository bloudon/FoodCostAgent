...
- Mobile "add" count updates must use the server's atomic increment (`addQty` dialect), never client-computed absolute quantities. **Why:** read-then-write sums lose concurrent updates across devices.
