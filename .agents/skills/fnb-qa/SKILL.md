...
- Reviewing a completed Level 2 or Level 3 task.
...
- Test the approved behavior independently of the implementer's claims.
...
- Use `PASS`, `PASS WITH FOLLOW-UP`, `BLOCKED`, or `NOT APPLICABLE`, with notes.
...
- Do not approve architecture or waive a Security/Architecture block.
